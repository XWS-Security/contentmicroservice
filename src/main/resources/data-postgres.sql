...
INSERT INTO public.nistagram_user(
	user_type, id, administration_role, enabled, last_password_reset_date, username, about, profile_picture, private_profile)
	VALUES ('INSTAGRAM_USER', '1', 'NISTAGRAM_USER_ROLE', true, '2017-10-01 21:58:58.508-07', 'luka',
...
INSERT INTO public.nistagram_user(
	user_type, id, administration_role, enabled, last_password_reset_date, username, about, profile_picture, private_profile)
	VALUES ('INSTAGRAM_USER', '6', 'NISTAGRAM_USER_ROLE', true, '2017-10-01 21:58:58.508-07', 'kobra',
	'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' ||
    ' When an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Profile3.jpg', true);
